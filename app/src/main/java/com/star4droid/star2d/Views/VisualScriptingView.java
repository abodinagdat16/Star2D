...
public class VisualScriptingView extends LinearLayout {
    ...
    private void initializeLogic() {
        ...
        show.setBackground(new GradientDrawable() {
            public GradientDrawable getIns(int a, int b) {
                this.setCornerRadius(a);
                this.setColor(b);
                return this;
        ...
        if (!hintsLst.isEmpty()) {
            hintsL = new Gson().fromJson(hintsLst, new TypeToken<ArrayList<String>>() {
            }.getType());
        }
        ...
        for (final String nds : nodes.toString().split("\nsplit\n")) {
            ...
            if (split[0].startsWith("--")) {
                ...
                linearVV.setOnClickListener(_view -> {
                    for (int i = ((((ViewGroup) _view.getParent()).indexOfChild(_view) + 1)); i < linear.getChildCount(); i++) {
        ...
        if (!FileUtil.readFile(json_path).equals("")) {
            lm = new Gson().fromJson(FileUtil.readFile(json_path), new TypeToken<ArrayList<HashMap<String, Object>>>() {
            }.getType());
    ...
    class Node extends LinearLayout {
        ...
        public Node(Context ctx) {
            ...
            GradientDrawable i1 = new GradientDrawable(GradientDrawable.Orientation.RIGHT_LEFT, new int[]{color, color});
            ...
            GradientDrawable id = new GradientDrawable(GradientDrawable.Orientation.RIGHT_LEFT, new int[]{0xFF3C3C3C, 0xFF3C3C3C});
            ...
            TextViewCompat.setAutoSizeTextTypeUniformWithConfiguration(false_text, (1), (100000), (1), TextViewCompat.AUTO_SIZE_TEXT_TYPE_UNIFORM);
            TextViewCompat.setAutoSizeTextTypeUniformWithConfiguration(true_text, (1), (100000), (1), TextViewCompat.AUTO_SIZE_TEXT_TYPE_UNIFORM);
            TextViewCompat.setAutoSizeTextTypeUniformWithConfiguration(title, (1), (100000), (1), TextViewCompat.AUTO_SIZE_TEXT_TYPE_UNIFORM);
            ...
            right_circle.setOnTouchListener((v, event) -> {
            ...
            true_circle.setOnTouchListener((v, event) -> {
                int ev = event.getAction();
            ...
            false_circle.setOnTouchListener((v, event) -> {
                int ev = event.getAction();
                if (ev == MotionEvent.ACTION_DOWN) {
                    sc = (Circle) v;
                    sc.setTag("false");
		...
		*/
        ...
        public void loadFrom(HashMap<String, Object> map) {
            ...
            ArrayList<HashMap<String, Object>> lm = new Gson().fromJson(map.get("nf").toString(), new TypeToken<ArrayList<HashMap<String, Object>>>() {
            }.getType());
            for (HashMap<String, Object> hash : lm) {
                ValueSetter nf = new ValueSetter(getContext());
                nf.node = this;
    ...
    class ValueSetter extends LinearLayout {
        ...
        public ValueSetter(Context ctx) {
            ...
            //Setting Up UI
            TextViewCompat.setAutoSizeTextTypeUniformWithConfiguration(value, (1), (100000), (1), TextViewCompat.AUTO_SIZE_TEXT_TYPE_UNIFORM);
            TextViewCompat.setAutoSizeTextTypeUniformWithConfiguration(name, (1), (100000), (1), TextViewCompat.AUTO_SIZE_TEXT_TYPE_UNIFORM);

            update();

            this.setBackground(new GradientDrawable() {
                public GradientDrawable getIns(int a, int b) {
                    this.setCornerRadius(a);
                    this.setColor(b);
                    return this;
            ...
            value.setBackground(new GradientDrawable() {
                public GradientDrawable getIns(int a, int b) {
                    this.setCornerRadius(a);
                    this.setColor(b);
                    return this;
        ...
        public void update() {
            ...
            value.setPadding((int) (pxToDp(3) * scale), (int) (pxToDp(3) * scale), (int) (pxToDp(3) * scale), (int) (pxToDp(3) * scale));
            {
                LayoutParams params = new LayoutParams((int) (pxToDp(70) * scale), (int) (pxToDp(25) * scale));
                int top = 0;
                int bottom = 0;
        ...
        public void edit() {
            ...
            edit.setOnClickListener(_view -> {
                edit.setVisibility(View.GONE);
                text.setVisibility(View.GONE);
                edittext.setVisibility(View.VISIBLE);
            });
            del.setOnClickListener(_view -> {
                try {
                    ...
                    if ("abcdefghijklmnopqrstuvwxyz".contains(String.valueOf(text.getText().toString().charAt((int) (nx))).toLowerCase())) {
                        while ((!text.getText().toString().isEmpty()) && "abcdefghijklmnopqrstuvwxyz".contains(String.valueOf(text.getText().toString().charAt((int) (nx))).toLowerCase())) {
            ...
            for (String ss : hintsL) {
                ...
                txt.setText(ss);
                txt.setBackground(new GradientDrawable() {
    ...
    class Circle extends LinearLayout {
        ...
        public Circle(Context ctx) {
            ...
            parent = thisVV.findViewById(R.id.parent);
            update();
            circle.setBackground(new GradientDrawable() {
                public GradientDrawable getIns(int a, int b, int c, int d) {
                    this.setCornerRadius(a);
                    this.setStroke(b, c);
                    this.setColor(d);
        ...
        public void setSelect(boolean b) {
            if (b) circle.setBackground(new GradientDrawable() {
                public GradientDrawable getIns(int a, int b, int c, int d) {
                    this.setCornerRadius(a);
                    this.setStroke(b, c);
                    this.setColor(d);
            ...
            else circle.setBackground(new GradientDrawable() {
                public GradientDrawable getIns(int a, int b, int c, int d) {
                    this.setCornerRadius(a);
                    this.setStroke(b, c);
                    this.setColor(d);
    ...
    public class Listview1Adapter extends BaseAdapter {
        ...
        public View getView(final int _position, View _v, ViewGroup _container) {
            ...
            if (_data.get(_position).get("file").toString().equals("...")) {
                ...
                textview1.setText("...");
                linear1.setOnClickListener(_view13 -> {
                    try {
                ...
                if (FileUtil.isFile(_data.get(_position).get("file").toString())) {
                    ...
                    linear1.setOnClickListener(_view12 -> {
